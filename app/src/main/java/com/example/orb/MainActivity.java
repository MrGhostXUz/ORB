...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Registratsiya=findViewById(R.id.registratsiya);

        Paper.init(this);
        loadingBar=new ProgressDialog(this);

        Registratsiya.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child("Users").child(phone).exists())
                {
                    ...
                    if(userData.getPIN().equals(pass)){
                ...
                {
                    Toast.makeText(MainActivity.this, "Bunday telefon raqami "+phone+"ga ochilgan akkaunt mavjud emas", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
